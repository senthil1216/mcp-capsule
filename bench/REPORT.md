...
| run_tests | sandbox | allowed — sandbox decision correct; executed in container [exit_code=127] |
...
- safe / run_tests: sandbox decision correct; executed in container [exit_code=127]
